...
function usefullReview(product){
	$.ajax({
		...
		success: function(response){
			...
			$('.voteplus'+product).parent().attr('title',"You have already voted");
		}
	});
}
function uselessReview(product){
	$.ajax({
		...
		success: function(response){
			...
			$('.voteminus'+product).parent().attr('title',"You have already voted");
		}
	});
}
	...
	$.ajax({
		...
		success: function(response){
			if(response=='added'){
				...
				$('.balance-button.texted').html('In comparison');
			}
			if(response=='removed'){
				$('.balance-button').removeClass('active');
				$('.balance-button.texted').removeClass('disabled');
				$('.balance-button.texted').html('Comparison');
			}
			$.ajax({
				type: "POST",
				url: "/ajax/compare_quantity.php",
	...
	if(item.hasClass('active')){
		...
		$.ajax({
			...
			success: function(response){
				...
				$(itemClass+".texted").removeClass('disabled').html('Избранное');
				$.ajax({
					type: "POST",
		...
		$.ajax({
			...
			success: function(response){
				...
				$(itemClass+".texted").addClass('disabled').html('In the favorites');
				$.ajax({
					type: "POST",
					url: "/ajax/favourite_quantity.php",
