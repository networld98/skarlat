...
{
?>
			<div class="order-block order-block-sticky">
				<div id="basket-item-table"></div>
				<div class="order-block-basket__footer" id="footRoot">
					<div data-entity="basket-total-block" class="fullwidth">
						<button class="order-block-basket__buy" onclick="$('#order-form').submit();"><?=GetMessage("CHECKOUT")?></button>
					</div>
				</div>
			</div>
	<?
...
elseif ($arResult['EMPTY_BASKET'])
{
	?>
	<script>
		$('.progress.progress-querydb').remove();
	</script>
	<?
