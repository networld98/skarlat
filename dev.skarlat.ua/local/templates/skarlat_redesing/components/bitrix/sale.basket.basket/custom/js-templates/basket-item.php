...
<script id="basket-item-template" type="text/html">
    <li class="basket-list__item" id="basket-item-{{ID}}" data-entity="basket-item" data-id="{{ID}}">
        ...
        <div class="basket-product__info">
            <a href="{{DETAIL_PAGE_URL}}" class="basket-product__title">
                ...
                <div class="basket-product-price d-flex d-md-none">
                    <span class="basket-product-price__value">{{{SUM_PRICE}}}</span>
                    <span class="basket-product-price__currency">{{CURRENCY}}</span>
                </div>
            </a>
            <div class="basket-product__btn-block">
                <div class="product-quantity">
                    <button class="product-quantity-decrement" data-decrement="true">-</button>
                    <input type="number" value="1" class="product-quantity-value">
                    <button class="product-quantity-increment" data-increment="true">+</button>
                </div>

                <div class="basket-product__btn">
                    <div class="basket-product-price d-none d-md-flex"  id="basket-item-sum-price-{{ID}}">
                        <span class="basket-product-price__value">{{{SUM_PRICE}}}</span>
                        <span class="basket-product-price__currency">{{CURRENCY}}</span>
                    </div>
                    <button class="basket-product__remove" data-remove="true">Удалить</button>
                </div>
            </div>
        </div>
    </li>
