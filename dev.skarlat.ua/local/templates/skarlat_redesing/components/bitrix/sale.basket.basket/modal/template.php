...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	?>
		...
		<div class="modal-body modal-body-basket" id="basket-item-table">
		</div>
		<?
		if (
			$arParams['BASKET_WITH_ORDER_INTEGRATION'] !== 'Y'
		...
		{
			?>
			<div class="modal-footer modal-footer-basket" id="footRoot">
				<div class="basket__btn_wrapper" data-entity="basket-total-block">
