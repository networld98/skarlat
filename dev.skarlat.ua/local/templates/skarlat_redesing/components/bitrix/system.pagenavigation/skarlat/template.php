...
<div class="row d-flex">
    ...
    <div class="navigation-pages">
        ...
        ?>
            <?if ($bPrevDisabled):?>
                <a class="page-item page-icon page-arrow-prev disabled" target="_self" href="javascript:void(0)"> </a>
            <?else:?>
                <a class="page-item page-icon page-arrow-prev" target="_self" href="<?=$sPrevHref;?>"> </a>
            <?endif;?>
            ...
            do
            {
                if ($arResult["nStartPage"] <= 2 || $arResult["nEndPage"]-$arResult["nStartPage"] <= 1 || abs($arResult['nStartPage']-$arResult["NavPageNomer"])<=2)
                {
                    ...
                    elseif($arResult["nStartPage"] == 1 && $arResult["bSavePage"] == false):
                        ?>
                        <div class="page-item">
                            <a class="page-link" target="_self" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?=$arResult["nStartPage"]?></a>
                        </div>
                    <?
                    else:
                        ?>
                        <div class="page-item">
                            <a class="page-link" target="_self" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["nStartPage"]?>"><?=$arResult["nStartPage"]?></a>
                        </div>
                    <?
                    endif;
                    $bFirst = false;
            ...
            ?>
        <?if ($bNextDisabled):?>
            <a class="page-item page-icon page-arrow-next disabled" target="_self" href="javascript:void(0)"> </a>
        <?else:?>
            <a class="page-item page-icon page-arrow-next" target="_self" href="<?=$sNextHref;?>"> </a>
        <?endif;?>
    </div>
    </div>
    </nav>
