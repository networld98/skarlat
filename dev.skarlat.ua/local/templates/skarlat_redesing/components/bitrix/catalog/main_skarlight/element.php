...
<?
if ($_SESSION['DETAIL_CUSTOM_TITLE']) {
    $APPLICATION->SetTitle($_SESSION['DETAIL_CUSTOM_TITLE']);
    unset($_SESSION['DETAIL_CUSTOM_TITLE']);
}
if($_SESSION['CUSTOM_DESCRIPTION']){
	$APPLICATION->SetPageProperty("description", $_SESSION['CUSTOM_DESCRIPTION']);
	 unset($_SESSION['CUSTOM_DESCRIPTION']);
}
?>
