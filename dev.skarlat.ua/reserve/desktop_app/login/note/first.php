					...
					<div class="binking__panels">
						<div class="binking__panel binking__front-panel">
							...
							<div class="binking__front-fields">
								...
								<input name="fields[1]" maxlength="2" data-pattern="[0-9]*" class="binking__field binking__month-field binking__date-field" type="text" placeholder="ММ" <?php echo safe_array_access($_GET, 'debug') ? 'value="05"' : ''; ?>>
