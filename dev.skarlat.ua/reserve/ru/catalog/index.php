...
if($_REQUEST['SALE']!=''){
	...
	$sale=($_REQUEST['SALE']!='') ? "?SALE=".$_REQUEST['SALE'] : "";

	if($now_date<$end_date){
		if(is_array($arSaleProps['PRODUCTS_'.$site]['VALUE']) && is_array($arSaleProps['SECTIONS_'.$site]['VALUE'])){
			$arrFilter[0]['LOGIC']="OR";
			$arrFilter[0][0]["ID"]=$arSaleProps['PRODUCTS_'.$site]['VALUE'];
			$arrFilter[0][1]["SECTION_ID"]=$arSaleProps['SECTIONS_'.$site]['VALUE'];
		}elseif(is_array($arSaleProps['PRODUCTS_'.$site]['VALUE'])){
			$arrFilter["ID"]=$arSaleProps['PRODUCTS_'.$site]['VALUE'];
		}elseif(is_array($arSaleProps['SECTIONS_'.$site]['VALUE'])){
			$arrFilter["SECTION_ID"]=$arSaleProps['SECTIONS_'.$site]['VALUE'];
		}
	}
}
	...
	<div class="subscribe-main">
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-5 d-flex align-items-center catalog-subscribe-form">
					<?$APPLICATION->IncludeComponent(
